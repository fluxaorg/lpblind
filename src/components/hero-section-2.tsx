    ...
    return (
        <>
            ...
            <main className="overflow-hidden">
                <section className="bg-white text-zinc-900 rounded-b-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                    <div className="relative pt-24 pb-16">
                        <div className="absolute inset-0 z-0 size-full [background:radial-gradient(125%_125%_at_50%_100%,transparent_0%,#ffffff_75%)]"></div>
                        <div className="mx-auto max-w-5xl px-6">
                            <div className="sm:mx-auto lg:mr-auto">
                                ...
                                >
                                    <div className="mb-6 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-100 border border-orange-200 text-xs font-bold text-orange-600 uppercase tracking-widest shadow-sm">
                                        <span className="w-2 h-2 rounded-full bg-orange-500 animate-pulse"></span>
                                        A Revolução na Gestão
                                    </div>
                                    <h1
                                        className="max-w-4xl text-balance text-5xl font-black md:text-7xl lg:text-[5.5rem] tracking-tight text-zinc-900 mb-8 leading-[1.05]">
                                    ...
                                    <p
                                        className="mt-6 max-w-2xl text-pretty text-lg md:text-xl text-zinc-600 mb-10 leading-relaxed font-medium">
                                        Domine o fluxo da sua oficina. Gestão visual, controle financeiro em tempo real e transparência total para o seu cliente final.
                                    </p>
                ...
                <div className="mx-auto max-w-5xl px-6 transition-all duration-300">
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full items-center justify-between gap-12 lg:w-auto">
                            <Link
                                href="/"
                                className="block text-sm duration-150 hover:opacity-75 text-zinc-500 font-medium">
                                <span>Grandes Parceiros Confiam</span>
